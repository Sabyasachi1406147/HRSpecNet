...
class TF(torch.nn.Module):
    def __init__(self):
        ...
        self.encoder = nn.Sequential( # like the Composition layer you built
            ...
            nn.LeakyReLU(0.2),
            # nn.SELU(),
            nn.Conv1d(ae_filters,ae_filters,kernel_size,self.stride,self.padding_conv-1), #padding_conv
            nn.BatchNorm1d(ae_filters),
            nn.LeakyReLU(0.2),
            # nn.SELU(),
            nn.Conv1d(ae_filters,ae_filters,kernel_size,self.stride,self.padding_conv), #padding_conv-1
            nn.BatchNorm1d(ae_filters),
            nn.LeakyReLU(0.2),
            # nn.SELU(),
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ConvTranspose1d(ae_filters, ae_filters, kernel_size, self.stride, self.padding_trans, self.output_padding-1),
            nn.BatchNorm1d(ae_filters),
            nn.LeakyReLU(0.2),
            # nn.SELU(),
            ...
            nn.LeakyReLU(0.2),
            # nn.SELU(),
            nn.ConvTranspose1d(ae_filters, ae_filters, kernel_size, self.stride, self.padding_trans-1, self.output_padding),
            nn.BatchNorm1d(ae_filters),
            nn.LeakyReLU(0.2),
            # nn.SELU(),
